  ...
  Widget _buildCard() {
    return Container(
      ...
      margin: EdgeInsets.symmetric(
          horizontal: MediaQuery.of(context).size.width > 360 ? 24 : 16),
      decoration: BoxDecoration(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                minimumSize: Size(double.infinity, isSmallScreen ? 40 : 50),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(12),
                ),
              ...
              child: Row(
                children: [
                  Icon(Icons.info_outline,
                      color: Colors.white70, size: isSmallScreen ? 14 : 18),
